...
const TRANSLATIONS = {
  en: {
    ...
    "changelog.subtitle": "Here's everything that changed recently.",
    "changelog.btnTitle": "What's New",
    ...
    "planMission.createdBy": "Created by",
    ...
    "planMission.extraCol.addToReqs": "Add to requirements",
    ...
    "history.badge.user": "User",
    "history.preferences": "Preferences",
    "history.update.userPwdReset": "Password reset for {name}",
    "history.update.userRole": "Role updated for {name}",
    "history.empty": "No history entries found.",
    "history.noResults": "No entries match the current filters.",
    "history.search": "Search history…",
    "history.date.all": "All time",
    "history.date.today": "Today",
    "history.date.24h": "24 h",
    "history.date.week": "Week",
    "history.user.all": "All users",
    "history.loadMore": "Load more",
    "history.grouped": "{count} devices updated",
    "history.field.deviceType": "Device type",
    "history.field.siteName": "Site",
    "history.field.sectorName": "Sector",
    ...
    "history.field.timeStart": "Start time",
    "history.field.timeEnd": "End time",
    "history.field.reqCount": "Requirements",
    "history.create.radio": "Added {device} to {site}",
    "history.create.radioWithBand": "Added {device} ({band}) to {site}",
    "history.create.sector": 'Created sector "{name}"',
    "history.create.site": 'Added site "{name}"',
    "history.create.siteInSector": 'Site "{name}" added to sector {sector}',
    ...
    "history.update.sectorNamed": 'Edited sector "{name}"',

    "history.update.siteNamed": 'Edited site "{name}"',
    "history.update.mission": 'Updated mission "{name}"',
    "history.update.linkNamed": 'Link "{name}" updated',
    ...
    "history.delete.radioDetail":
      "Device {device} ({band}) removed from site {site}",
    "history.trigger.allocate": "Auto · Allocate",
    "history.trigger.standby": "Auto · Standby",
    "history.trigger.activateStandby": "Auto · Activate Standby",
    "history.trigger.demoteStandby": "Auto · Demote",
    "history.trigger.endMission": "Auto · End Mission",
    "history.trigger.missionRename": "Auto · Mission Renamed",
    "history.delete.sector": 'Sector "{name}" removed',
    "history.delete.sectorWithSites":
      'Sector "{name}" removed ({count} site(s) removed)',
    "history.delete.site": 'Deleted site "{name}"',
    "history.delete.siteFromSector":
      'Site "{name}" removed from sector {sector}',
    ...
    "history.delete.linkDetail": "Link removed: {name} ({frequency} MHz)",
    ...
    "notify.roleUpdated": "{count} device role(s) updated",
    ...
    "sync.by": "by {user}",
    "sync.missionStarted": "Mission '{name}' started",
    "sync.missionEnded": "Mission '{name}' ended",
    "sync.missionArchived": "Mission '{name}' archived",
    "sync.missionActivated": "Mission '{name}' activated",
    "sync.missionDeactivated": "Mission '{name}' returned to planning",
    "sync.missionUpdated": "Mission updated",
    "sync.radioUpdated": "Device updated",
    "sync.structureUpdated": "Structure updated",
    "sync.configUpdated": "Settings updated",
    "sync.batchClear": "Site '{name}' cleared",
    "sync.import": "Backup imported",
    ...
    "error.freqNotAligned":
      "Frequency must be a multiple of {step} MHz for {band} band",
    "error.freqNotAlignedRow":
      "Row {row}: frequency {freq} is not a multiple of {step} MHz for {band} band",
    "error.selectDeviceType": "Please select a device type",
    "error.fillRequired": "Please fill in all required fields",
    "error.serverUnreachable": "Server is unreachable — check your connection",
    ...
    "pref.col.role": "Role",
    "pref.col.owner": "Belonging",
    "pref.col.lastLogin": "Last Login",
    "pref.noUsers": "No users found",
    "pref.ownerRequired": "Belonging is required for user role",
    "pref.selectOwner": "Select belonging...",
    "pref.resetPwd.tooltip": "Reset password",
    "pref.resetPwd.title": "Password Change",
    "pref.resetPwd.subtitle": "For user: {name}",
    "pref.resetPwd.newPwd": "New Password",
    "pref.resetPwd.confirmPwd": "Confirm Password",
    "pref.resetPwd.tooShort": "Password must be at least 6 characters",
    "pref.resetPwd.mismatch": "Passwords do not match",
    "pref.resetPwd.match": "Passwords match",
    "pref.resetPwd.minLength": "At least 6 characters",
    "pref.resetPwd.success": "Password reset successfully",
    "pref.role.admin": "מנהל",
    "pref.role.user": "משתמש",
    "pref.online": "מחובר",
    "pref.offline": "לא מחובר",
    "pref.roles.help.tooltip": "Role permissions explanation",
    "pref.roles.help.title": "Role Permissions",
    "pref.roles.help.admin.title": "Admin — Full Access",
    "pref.roles.help.admin.p1":
      "Edit all devices, sites, sectors and frequencies",
    "pref.roles.help.admin.p2": "Start, end and manage missions",
    "pref.roles.help.admin.p3": "Manage users, owners and device types",
    "pref.roles.help.admin.p4": "Import and export data",
    "pref.roles.help.user.title": "User — Limited Access",
    "pref.roles.help.user.p1": "View all data in read-only mode",
    "pref.roles.help.user.p2": "Plan and edit missions only",
    "pref.roles.help.user.p3": "Cannot edit devices, sites or settings",
  ...
  he: {
    ...
    "login.sessionExpired": "אבד החיבור — אנא התחבר מחדש",
    ...
    "changelog.subtitle": "הנה כל מה שהתעדכן לאחרונה.",
    "changelog.btnTitle": "מה חדש",
    "changelog.empty": "אין עדכונים עדיין.",
    "changelog.new": "חדש",
    "btn.dark": "🌙 כהה",
    "btn.light": "☀️ בהיר",
    ...
    "missions.col.status": "סטטוס",
    "missions.status.active": "פעיל",
    "missions.status.planned": "מתוכנן",
    ...
    "planMission.createdBy": "נוצר על ידי",
    "planMission.deviceReqs": "מכשירים נדרשים",
    ...
    "planMission.extraCol.addToReqs": "הוסף לדרישות",
    ...
    "history.badge.user": "משתמש",
    "history.preferences": "העדפות",
    "history.update.userPwdReset": "איפוס סיסמה עבור {name}",
    "history.update.userRole": "עודכן תפקיד עבור {name}",
    "history.empty": "לא נמצאה היסטוריה.",
    "history.noResults": "אין רשומות התואמות את הסינון הנוכחי.",
    "history.search": "חיפוש בהיסטוריה…",
    "history.date.all": "כל הזמן",
    "history.date.today": "היום",
    "history.date.24h": "24 שעות",
    "history.date.week": "שבוע",
    "history.user.all": "כל המשתמשים",
    "history.loadMore": "טען עוד",
    "history.grouped": "{count} מכשירים עודכנו",
    "history.field.deviceType": "סוג מכשיר",
    "history.field.siteName": "אתר",
    "history.field.sectorName": "גזרה",
    ...
    "history.field.notes": "הערות",
    "history.field.timeStart": "זמן התחלה",
    "history.field.timeEnd": "זמן סיום",
    "history.field.reqCount": "דרישות",
    "history.create.radio": "נוסף {device} ל-{site}",
    "history.create.radioWithBand": "נוסף {device} ({band}) ל-{site}",
    "history.create.sector": 'נוצרה גזרה "{name}"',
    "history.create.site": 'נוסף אתר "{name}"',
    "history.create.siteInSector": 'אתר "{name}" נוסף לגזרה {sector}',
    ...
    "history.update.sectorNamed": 'נערכה גזרה "{name}"',
    "history.update.siteNamed": 'נערך אתר "{name}"',
    "history.update.mission": 'עודכנה משימה "{name}"',
    "history.update.linkNamed": 'קישור "{name}" עודכן',
    ...
    "history.delete.radioDetail": "מכשיר {device} ({band}) הוסר מאתר {site}",
    "history.trigger.allocate": "אוטו' · הקצאה",
    "history.trigger.standby": "אוטו' · כוננות",
    "history.trigger.activateStandby": "אוטו' · הפעלת כוננות",
    "history.trigger.demoteStandby": "אוטו' · הורדה לכוננות",
    "history.trigger.endMission": "אוטו' · סיום משימה",
    "history.trigger.missionRename": "אוטו' · שינוי שם משימה",
    "history.delete.sector": 'גזרה "{name}" נמחקה',
    "history.delete.sectorWithSites":
      'גזרה "{name}" נמחקה ({count} אתרים הוסרו)',
    "history.delete.site": 'נמחק אתר "{name}"',
    "history.delete.siteFromSector": 'אתר "{name}" הוסר מגזרה {sector}',
    ...
    "history.delete.linkDetail": 'הקישור "{name}" הוסר ({frequency} MHz)',
    ...
    "summary.totalSectors": 'סה"כ גזרות',
    "summary.totalSites": 'סה"כ אתרים',
    "summary.totalRadios": 'סה"כ מכשירים',
    ...
    "notify.roleUpdated": "עודכנו תפקידים ל-{count} מכשירים",
    ...
    "sync.by": "על ידי {user}",
    "sync.missionStarted": "משימה '{name}' הופעלה",
    "sync.missionEnded": "משימה '{name}' הסתיימה",
    "sync.missionArchived": "משימה '{name}' הועברה לארכיון",
    "sync.missionActivated": "משימה '{name}' הופעלה",
    "sync.missionDeactivated": "משימה '{name}' חזרה לתכנון",
    "sync.missionUpdated": "משימה עודכנה",
    "sync.radioUpdated": "מכשיר עודכן",
    "sync.structureUpdated": "מבנה עודכן",
    "sync.configUpdated": "הגדרות עודכנו",
    "sync.batchClear": "אתר '{name}' נוקה",
    "sync.import": "גיבוי יובא",
    ...
    "error.freqNotAligned":
      "התדר חייב להיות כפולה של {step} MHz עבור תחום {band}",
    "error.freqNotAlignedRow":
      "שורה {row}: תדר {freq} אינו כפולה של {step} MHz עבור תחום {band}",
    "error.selectDeviceType": "נא לבחור סוג מכשיר",
    "error.fillRequired": "נא למלא את כל השדות הנדרשים",
    "error.serverUnreachable": "השרת אינו נגיש — בדוק את החיבור",
    ...
    "pref.band.min": "מינימום",
    "pref.band.max": "מקסימום",
    "pref.band.step": "צעד",
    ...
    "pref.ownerRequired": "חובה לבחור שיוך עבור תפקיד משתמש",
    "pref.selectOwner": "בחר שיוך...",
    "pref.resetPwd.tooltip": "איפוס סיסמה",
    "pref.resetPwd.title": "שינוי סיסמה",
    "pref.resetPwd.subtitle": "עבור משתמש: {name}",
    "pref.resetPwd.newPwd": "סיסמה חדשה",
    "pref.resetPwd.confirmPwd": "אימות סיסמה",
    "pref.resetPwd.tooShort": "הסיסמה חייבת להכיל לפחות 6 תווים",
    "pref.resetPwd.mismatch": "הסיסמאות אינן תואמות",
    "pref.resetPwd.match": "הסיסמאות תואמות",
    "pref.resetPwd.minLength": "לפחות 6 תווים",
    "pref.resetPwd.success": "הסיסמה אופסה בהצלחה",
    "pref.roles.help.tooltip": "הסבר על הרשאות תפקידים",
    "pref.roles.help.title": "הרשאות תפקידים",
    "pref.roles.help.admin.title": "מנהל — גישה מלאה",
    "pref.roles.help.admin.p1": "עריכת כל המכשירים, האתרים, הגזרות והתדרים",
    "pref.roles.help.admin.p2": "הפעלה, סיום וניהול משימות",
    "pref.roles.help.admin.p3": "ניהול משתמשים, בעלים וסוגי מכשירים",
    "pref.roles.help.admin.p4": "ייבוא וייצוא נתונים",
    "pref.roles.help.user.title": "משתמש — גישה מוגבלת",
    "pref.roles.help.user.p1": "צפייה בכל הנתונים במצב קריאה בלבד",
    "pref.roles.help.user.p2": "תכנון ועריכת משימות בלבד",
    "pref.roles.help.user.p3": "אין אפשרות לערוך מכשירים, אתרים או הגדרות",
    "pref.role.admin": "מנהל",
    "pref.role.user": "משתמש",
    "pref.online": "מחובר",
    "pref.offline": "לא מחובר",
