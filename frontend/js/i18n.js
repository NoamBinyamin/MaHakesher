...
const TRANSLATIONS = {
  en: {
    ...
    "login.invalidCredentialsCount":
      "Invalid username or password — attempt {count} of {max}",
    "login.accountLocked":
      "Too many failed attempts. Try again in {time} (minutes:seconds).",
    ...
    "login.connectionLost":
      "Connection to the server was lost — please log in again",
    ...
    "timeline.tooltip.status": "Status",
    "timeline.legend.title": "Legend:",
    "timeline.filter.both": "Both",
    "timeline.filter.active": "Active",
    "timeline.filter.planned": "Planned",
    "timeline.jumpToNow": "Jump to now",
    "timeline.addNote": "Add Note",
    "timeline.manageNotes": "All Notes",
    "timeline.allNotes.title": "All Timeline Notes",
    "timeline.allNotes.empty": "No timeline notes yet.",
    "timeline.annotation.modalTitle": "Timeline Note",
    "timeline.annotation.date": "Date",
    "timeline.annotation.text": "Note",
    "timeline.annotation.color": "Color",
    "timeline.annotation.textPlaceholder":
      "e.g. Exercise start, comms outage, equipment delivery...",
    "timeline.annotation.by": "Added by",
    "timeline.annotation.required": "Date and note text are required",

    // ── Link Dictionary ───────────────────────────────────────
    "links.title": "Link Dictionary",
    "links.addLink": "Add Link",
    "links.template": "Template",
    "links.exportExcel": "Export Excel",
    "links.exportEmpty": "No links to export",
    ...
    "history.badge.timelineAnnotation": "Timeline Note",
    ...
    "history.field.maintenanceReason": "Maintenance reason",
    "history.field.maintenanceReturnDate": "Expected return date",
    ...
    "history.field.annotationDate": "Date",
    "history.field.annotationText": "Note",
    ...
    "history.create.timelineAnnotation": "Added note on {date}",
    ...
    "history.update.timelineAnnotation": "Updated timeline note",
    ...
    "history.delete.timelineAnnotation": "Removed note on {date}",
    ...
    "history.rollback": "Rolled back to pre-import backup",
    ...
    "radio.maintenance.title": "Maintenance Details",
    "radio.maintenance.reason": "Reason",
    "radio.maintenance.reasonPlaceholder":
      "e.g. Broken antenna, Sent for repair...",
    "radio.maintenance.returnDate": "Expected Return Date",
    "radio.maintenance.duration": "Time in maintenance",
    "common.durationDays": "{count}d",
    "common.durationHours": "{count}h",
    "common.durationMinutes": "{count}m",
    ...
    "notify.sectorAdded": "Sector added successfully",
    "notify.sectorUpdated": "Sector updated successfully",
    ...
    "notify.annotationAdded": "Note added to timeline",
    "notify.annotationAddFailed": "Failed to add note: {error}",
    "notify.annotationUpdated": "Note updated",
    "notify.annotationUpdateFailed": "Failed to update note: {error}",
    "notify.annotationDeleted": "Note removed from timeline",
    "notify.annotationDeleteFailed": "Failed to remove note: {error}",
    ...
    "sync.annotationAdded": "Timeline note added",
    "sync.annotationRemoved": "Timeline note removed",
    "notify.exportOk": "Backup exported successfully",
    "notify.exportFailed": "Failed to export data: {error}",
    "notify.importOk": "Data imported successfully",
    "notify.importBadFile": "Invalid backup file: missing data",
    "notify.importFailed": "Failed to import data: {error}",
    "import.modal.title": "Import Backup",
    "import.modal.exportedAt": "Exported",
    "import.modal.current": "Current",
    "import.modal.inFile": "In File",
    "import.modal.diff": "Diff",
    "import.modal.radios": "Radios",
    "import.modal.links": "Links",
    "import.modal.missions": "Missions",
    "import.modal.sectors": "Sectors",
    "import.modal.sites": "Sites",
    "import.modal.owners": "Owners",
    "import.modal.devices": "Device Types",
    "import.modal.annotations": "Timeline Notes",
    "import.modal.warnings": "reference warnings",
    "import.modal.warning": "This will permanently replace ALL current data.",
    "import.modal.warningDetail":
      "A rollback backup is saved automatically — you can restore it from Preferences.",
    "import.modal.confirm": "Import & Replace",
    "import.rollback.confirm": "Restore the data from before the last import?",
    "import.rollback.ok": "Data restored successfully",
    "import.rollback.failed": "Rollback failed",
    "import.rollback.btn": "Restore Pre-Import Backup",
    "import.rollback.hint": "Restores data from before the last import.",
    ...
    "error.missionEndBeforeStart": "End date must be after start date",
    ...
    "import.mission.noSectorOrSite":
      "Row {row}: Must specify at least Sector or Site",
    "import.mission.siteNotInSector":
      'Row {row}: Site "{site}" does not belong to sector "{sector}"',
    ...
    "confirm.deleteTimelineAnnotation": "Remove this note from the timeline?",
    ...
    // ── Preferences tab ───────────────────────────────────────
    "pref.data.title": "Data Backup",
    "export.radios.btn": "Export Radios (Excel)",
    "export.col.sector": "Sector",
    "export.col.site": "Site",
    "export.col.band": "Band",
    "export.col.device": "Device Type",
    "export.col.freq": "Frequency",
    "export.col.owner": "Owner",
    "export.col.mission": "Mission",
    "export.col.role": "Role",
    "export.col.standbyFreq": "Standby Freq",
    "export.col.standbyOwner": "Standby Owner",
    "export.col.standbyMission": "Standby Mission",
    "export.col.standbyRole": "Standby Role",
    "export.col.status": "Status",
    "export.col.notes": "Notes",
  ...
  he: {
    ...
    "login.invalidCredentialsCount":
      "שם משתמש או סיסמה שגויים — ניסיון {count} מתוך {max}",
    "login.accountLocked": "יותר מדי ניסיונות כושלים. נסו שוב בעוד {time}.",
    "login.capsLockOn": "מקש Caps Lock פעיל",
    "login.loggedOut": "התנתקת בהצלחה",
    "login.sessionExpired": "אבד החיבור — אנא התחבר מחדש",
    "login.connectionLost": "החיבור לשרת אבד — אנא התחבר מחדש",
    ...
    "missions.status.planned": "בתכנון",
    ...
    "timeline.noMissions": "אין משימות פעילות או מתוכננות להצגה.",
    "timeline.noScheduled":
    ...
    "timeline.tooltip.status": "סטטוס",
    "timeline.legend.title": "מקרא:",
    "timeline.filter.both": "שניהם",
    "timeline.filter.active": "פעיל",
    "timeline.filter.planned": "מתוכנן",
    "timeline.jumpToNow": "קפוץ להווה",
    "timeline.addNote": "הוסף הערה",
    "timeline.manageNotes": "כל ההערות",
    "timeline.allNotes.title": "כל הערות ציר הזמן",
    "timeline.allNotes.empty": "אין הערות בציר הזמן עדיין.",
    "timeline.annotation.modalTitle": "הערה על הציר",
    "timeline.annotation.date": "תאריך",
    "timeline.annotation.text": "הערה",
    "timeline.annotation.color": "צבע",
    "timeline.annotation.textPlaceholder":
      "לדוגמה: תחילת תרגיל, אימון חשוב, השבתה...",
    "timeline.annotation.by": "נוסף על ידי",
    "timeline.annotation.required": "יש למלא תאריך וטקסט הערה",

    // ── Link Dictionary ───────────────────────────────────────
    "links.title": "קישור תדר לעורק",
    "links.addLink": "הוספת התאמה",
    "links.template": "הורדת תבנית",
    "links.exportExcel": "ייצא Excel",
    "links.exportEmpty": "אין קישורים לייצא",
    ...
    "history.badge.timelineAnnotation": "הערת ציר זמן",
    "history.timeline": "ציר זמן",
    ...
    "history.field.maintenanceReason": "סיבת תחזוקה",
    "history.field.maintenanceReturnDate": "תאריך חזרה צפוי",
    ...
    "history.field.annotationDate": "תאריך",
    "history.field.annotationText": "הערה",
    ...
    "history.create.timelineAnnotation": "נוספה הערה בתאריך {date}",
    ...
    "history.update.timelineAnnotation": "עודכנה הערת ציר זמן",
    ...
    "history.delete.timelineAnnotation": "הוסרה הערה בתאריך {date}",
    ...
    "history.rollback": "שוחזר לגיבוי לפני הייבוא",
    ...
    "radio.maintenance.title": "מכשיר בתחזוקה",
    "radio.maintenance.reason": "סיבה",
    "radio.maintenance.reasonPlaceholder": "לדוג' - תקלת אנטנה, נשלח לתיקון...",
    "radio.maintenance.returnDate": "תאריך חזרה צפוי",
    "radio.maintenance.duration": "זמן בתקלה",
    "common.durationDays": "{count} ימים",
    "common.durationHours": "{count} שעות",
    "common.durationMinutes": "{count} דקות",
    ...
    "notify.sectorSaved": "הגזרה נשמרה בהצלחה",
    "notify.sectorAdded": "הגזרה נוספה בהצלחה",
    "notify.sectorUpdated": "הגזרה עודכנה בהצלחה",
    ...
    "notify.annotationAdded": "ההערה נוספה לציר הזמן",
    "notify.annotationAddFailed": "הוספת ההערה נכשלה: {error}",
    "notify.annotationUpdated": "ההערה עודכנה",
    "notify.annotationUpdateFailed": "עדכון ההערה נכשל: {error}",
    "notify.annotationDeleted": "ההערה הוסרה מציר הזמן",
    "notify.annotationDeleteFailed": "הסרת ההערה נכשלה: {error}",
    ...
    "sync.annotationAdded": "נוספה הערה לציר הזמן",
    "sync.annotationRemoved": "הערה הוסרה מציר הזמן",
    "notify.exportOk": "הגיבוי נוצר בהצלחה",
    "notify.exportFailed": "כשלון בייצוא המידע: {error}",
    "notify.importOk": "המידע הועלה בהצלחה",
    "notify.importBadFile": "קובץ גיבוי לא תקין",
    "notify.importFailed": "כשלון בעדכון המידע: {error}",
    "import.modal.title": "ייבוא גיבוי",
    "import.modal.exportedAt": "יוצא ב",
    "import.modal.current": "נוכחי",
    "import.modal.inFile": "בקובץ",
    "import.modal.diff": "הפרש",
    "import.modal.radios": "מכשירים",
    "import.modal.links": "קישורים",
    "import.modal.missions": "משימות",
    "import.modal.sectors": "גזרות",
    "import.modal.sites": "אתרים",
    "import.modal.owners": "בעלים",
    "import.modal.devices": "סוגי מכשירים",
    "import.modal.annotations": "הערות ציר זמן",
    "import.modal.warnings": "אזהרות",
    "import.modal.warning": "פעולה זו תחליף לצמיתות את כל הנתונים הנוכחיים.",
    "import.modal.warningDetail":
      "גיבוי לשחזור נשמר אוטומטית — ניתן לשחזר מהגדרות.",
    "import.modal.confirm": "ייבא והחלף",
    "import.rollback.confirm": "לשחזר את הנתונים מלפני הייבוא האחרון?",
    "import.rollback.ok": "הנתונים שוחזרו בהצלחה",
    "import.rollback.failed": "השחזור נכשל",
    "import.rollback.btn": "שחזר גיבוי לפני הייבוא",
    "import.rollback.hint": "משחזר נתונים מלפני הייבוא האחרון.",
    ...
    "error.missionEndBeforeStart": "תאריך הסיום חייב להיות אחרי תאריך ההתחלה",
    ...
    "import.mission.noSectorOrSite": "שורה {row}: יש לציין לפחות גזרה או אתר",
    "import.mission.siteNotInSector":
      'שורה {row}: האתר "{site}" אינו שייך לגזרה "{sector}"',
    ...
    "confirm.deleteTimelineAnnotation": "להסיר את ההערה הזו מציר הזמן?",
    ...
    // ── Preferences tab ───────────────────────────────────────
    "pref.data.title": "גיבוי נתונים",
    "export.radios.btn": "ייצא פריסת מכשירים (Excel)",
    "export.col.sector": "גזרה",
    "export.col.site": "אתר",
    "export.col.band": "תחום",
    "export.col.device": "סוג מכשיר",
    "export.col.freq": "תדר",
    "export.col.owner": "בעלים",
    "export.col.mission": "משימה",
    "export.col.role": "תפקיד",
    "export.col.standbyFreq": "תדר כוננות",
    "export.col.standbyOwner": "בעלים כוננות",
    "export.col.standbyMission": "משימת כוננות",
    "export.col.standbyRole": "תפקיד כוננות",
    "export.col.status": "סטטוס",
    "export.col.notes": "הערות",
